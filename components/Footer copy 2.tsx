        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=1" className="text-muted-foreground hover:text-foreground transition-colors">
                  Casques de Protection
                </Link>
              </li>
              <li>
                <Link href="/products?category=2" className="text-muted-foreground hover:text-foreground transition-colors">
                  Vêtements de Travail
                </Link>
              </li>
              <li>
                <Link href="/products?category=7" className="text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li>55 KTM Rue koketi immeuble st Hubert,</li>
              <li>01 BP 2440 Assivito lomé, Togo</li>
              <li>Tél: 91 21 82 26</li>
              <li>Email: contact@fullness-safety.com</li>
            </ul>
          </div>
        </div>
