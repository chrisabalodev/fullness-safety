        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              Explorez notre gamme complète d'équipements de protection individuelle dans notre catalogue 2024. Plus de 500 produits certifiés pour votre sécurité.
            </p>
            <Button size="lg" className="h-12" asChild>
              <Link 
                href="https://example.com/catalogue-2024.pdf" 
                target="_blank"
          ...
          <div className="relative">
            <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl relative group hover-lift">
              <img
                src="https://images.unsplash.com/photo-1603732551658-5fabbafa84eb?auto=format&fit=crop&q=80&w=1000"
                alt="Catalogue 2024"
                className="object-cover w-full h-full transition-transform duration-500 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                <p className="text-lg font-semibold">Catalogue 2024</p>
